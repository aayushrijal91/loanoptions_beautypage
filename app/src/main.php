            ...
            <div class="row gy-md-5">
                <div class="col-xl-8">
                    <div class="banner_left">
                        <div class="fs-96 lh-1 text-white font-articulat-heavy ls-2 mb-3 text-center text-md-start">More <span class="text-secondary-light">Options.</span> More <span class="text-paleyellow">Confidence.</span></div>
                ...
                <div class="col-xl-4">
                    <div class="banner_right h-100 rounded-20">
                        <div class="text-center">
                            <div class="font-articulat-heavy ls-2 fs-40 lh-1 text-white">Your <span class="text-paleyellow">Beauty & Aesthetics</span> Loan</div>
                            <div class="py-4 fs-20 text-white">Beauty shouldn't cost you an arm or leg.</div>
                            <div class="row align-items-center justify-content-center">
                                <div class="col-auto">
                                    <a href="https://loanoptions.ai/" target="_blank" class="btn btn-secondary-light d-inline-flex rounded-pill rounded-0 text-white px-4">Learn More</a>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="row h-100 align-items-center justify-content-around">
                        <div class="col-auto">
                            <svg width="49" height="50" viewBox="0 0 49 50" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <path d="M32.2197 18.6955L16.1098 0L0 18.6955H10.349V50H18.615V47.175H13.189V15.8705H6.17478L16.1098 4.34085L26.0449 15.8705H19.0306V23.0133H21.8706V18.6955H32.2197Z" fill="#DCC2AB" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M28.0482 23.4262C24.8665 23.4262 22.2873 25.9917 22.2873 29.1565C22.2873 32.3213 24.8665 34.8869 28.0482 34.8869C31.2298 34.8869 33.809 32.3213 33.809 29.1565C33.809 25.9917 31.2298 23.4262 28.0482 23.4262ZM25.1273 29.1565C25.1273 27.5519 26.435 26.2511 28.0482 26.2511C29.6613 26.2511 30.969 27.5519 30.969 29.1565C30.969 30.7611 29.6613 32.0619 28.0482 32.0619C26.435 32.0619 25.1273 30.7611 25.1273 29.1565Z" fill="#DCC2AB" />
                                <path fill-rule="evenodd" clip-rule="evenodd" d="M37.4784 44.2696C37.4784 41.1048 40.0576 38.5392 43.2392 38.5392C46.4208 38.5392 49 41.1048 49 44.2696C49 47.4344 46.4208 49.9999 43.2392 49.9999C40.0576 49.9999 37.4784 47.4344 37.4784 44.2696ZM43.2392 41.3642C41.6261 41.3642 40.3184 42.665 40.3184 44.2696C40.3184 45.8742 41.6261 47.1749 43.2392 47.1749C44.8523 47.1749 46.16 45.8742 46.16 44.2696C46.16 42.665 44.8523 41.3642 43.2392 41.3642Z" fill="#DCC2AB" />
                                <path d="M27.1823 49.4934L46.3197 25.6981L44.102 23.9333L24.9646 47.7286L27.1823 49.4934Z" fill="#DCC2AB" />
                            </svg>
                        </div>
...
<section class="equipment_loan">
    <div class="container">
        <div class="fs-96 lh-3 ls-2 text-dark font-articulat-heavy">Types Of Beauty Equipment Loans<span class="text-quaternary">.</span></div>

        <div class="row g-3 g-md-4 pt-4 pt-md-7">
            <div class="col-md-6 col-lg-4">
                <div class="loan_card">Laser Machines</div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="loan_card">Fat Loss Machines</div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="loan_card">Skin Tightening Equipment</div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="loan_card">Beauty Equipment</div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="loan_card">Gym Equipment</div>
            </div>
            <div class="col-md-6 col-lg-4">
                <div class="loan_card">& More!</div>
            </div>
        </div>
    </div>
</section>
...
<section class="industry_specialist">
    <div class="container">
        <div class="row align-items-center gx-xxl-6 gy-5">
            <div class="col-lg-6">
                <div class="fs-96 text-white font-articulat-heavy lh-3 ls-2">Our <span class="text-secondary-light">Beauty & Aesthetics</span> Industry Specialists</div>
                <div class="fs-20 text-secondary-light pt-md-5 pt-4 description">
                    <p>Having a specialist is important. This means that the person is trusted and knows what the h#@ll they are doing! We get that. That is why LoanOptions is trusted and we have consulted many laser clinics, health and well being centres and surgeons.</p>
                    <p>We are the preferred finance partner for Hyrdafacial and Candela Medical Lasers and many leading manufacturers. Our inhouse team of specialists have the knowledge and work exclusively with businesses in the beauty industry. We know all there is to know about operating in the beauty and the aesthetics business!</p>
                </div>
            </div>
            <div class="col-lg-6"><?= renderImg("abic-members.jpg", 'lib', 'rounded-20 w-100') ?></div>
        </div>
    </div>
</section>
...
<section class="equipment-financing">
    <div class="container">
        <h2 class="fs-96 fw-800 text-dark font-articulat-heavy lh-1 mb-5 mb-lg-7">Looking for Health & Beauty Equipment Financing?</h2>
        <div class="bg-white shadow py-md-5 py-4 px-xl-7 px-md-5 px-4 rounded-20 mb-5">
            <div class="row justify-content-around gx-5 gy-6 gy-xl-4">
                <div class="col-xl-5 order-2 order-md-1">
                    <div class="fs-64 fw-800 lh-1">Assisting no matter the circumstances<span class="text-quaternary">.</span></div>
                    <div class="text-dark-grey fs-20 py-4 description">
                        <p>A professional laser hair removal machine or hydrafacial equipment can break the bank and your business if you do not have the right equipment financing in place. The Health and Beauty industry for many is as complex as it is expensive to run. And we know that! It’s a tough environment for everyone at the moment and finding the finance you need can be overwhelming.</p>
                        <p>During COVID the risk of lockdown forced a lot of businesses, including those in Health and Beauty to shut down. It could be said that some lenders (won’t say which ones) turned their backs on the industry. LoanOptions however helped and continued to assist beauty clinics in finding laser machine loans, no matter what their circumstances.</p>
                    </div>
                    <a href="https://loanoptions.ai/" target="_blank" class="btn btn-quaternary d-inline-flex rounded-pill rounded-0 text-white px-4">Compare Beauty Loans</a>
                </div>
                <div class="col-xl-5 order-2 order-md-1">
                    <div class="fs-64 fw-800 lh-1">Proud members of the ABIC<span class="text-quaternary">.</span></div>
                    <div class="text-dark-grey fs-20 pt-4 description">
                        <p>LoanOptions are also proud members of the Aesthetic Beauty Industry Council (ABIC), and we understand the industry, how it operates, the costs and the people involved. We have experience consulting many businesses and in the past here are some of the equipment our customers require funding for.</p>
                        <ul class="text-secondary text-capitalize fw-600">
                            <li>Laser Machine Finance</li>
                            <li>Fat Loss Machine Finance</li>
                            <li>Skin Tightening Equipment Finance</li>
                            <li>Beauty Equipment finance</li>
                            <li>Gym Equipment Financing</li>
                            <li>Candela Laser Machine Finance</li>
                        </ul>
                        <p class="mb-0">If you are familiar with any of the above equipment, we are talking to you! With the click of a button, our AI-powered comparison tool sifts through 60+ lenders for you, including big banks and private lenders, then neatly arranges all your choices and relevant info in plain view. Leave the hard work to the AI, and then take your pick and focus on your well-being.</p>
                    </div>
                </div>
            </div>
        </div>
...
<section class="bg-secondary py-xl-10 py-md-6 py-5">
    <div class="container">
        <div class="row align-items-center gx-xxl-7 gy-5">
            <div class="col-lg-6">
                <div class="fs-96 text-white font-articulat-heavy lh-3 ls-2">Why a loan for could be right for you!</div>
                <div class="fs-20 text-light-grey py-4 description">
                    <p>On the flipside if you are looking to enhance your body we can also help you find the finance that suits you. Will you need to take time off? Are you an actor or model? What is the best financing for your profession? These will all be answered when you apply for a loan. It just won’t take you as long as you think. We use Ai Technology and over 100+ data points in order to match and compare loans that suit you… in seconds!</p>
                    <p>Getting the right loan can get you there! And how do you know it’s the one for you? Compare! Compare! Compare! LoanOptions’ loan comparison tool has all the important information you need to judge how suitable a loan is for you. Don’t be unsure again about whether or not this is the right course of action for you! Have confidence and look your best today!</p>
                </div>
            </div>
            <div class="col-lg"><?= renderImg("right-loan.jpg", 'lib', 'w-100 rounded-20') ?></div>
        </div>
    </div>
</section>
...
<section class="loan_security">
    <div class="container">
        ...
        <div class="description fs-20 text-white mb-xl-7 mb-md-5 mb-4">We have said it before, and we’ll say it again, not every loan is the same! When you are applying for a loan it can be either an unsecured or secured loan.
            Finding the right loan can be confusing and to make it easier we’ve defined the below.</div>
...
<section class="py-xl-10 py-md-6 py-5 bg-secondary">
    <div class="container">
        <div class="row align-items-center gx-xxl-6 gy-5 gy-lg-0">
            <div class="col-lg-6">
                ...
                <div class="fs-20 text-white py-md-5 py-4 description">
...
<section class="vision">
    <div class="container">
        <div class="row align-items-center pb-5 pb-md-7 gy-4">
            <div class="col-xl-5">
                <div class="fs-96 text-primary font-articulat-heavy text-center text-xl-start lh-3 ls-2">Our <span class="vision_heading_prefix">Vision</span><span class="text-green">.</span></div>
            </div>
            <div class="col-xl-6">
                ...
                <div class="row align-items-center gx-5">
                    <div class="col-auto d-none d-md-block">
                        <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M10 5.744L8 0L6 5.744H0L4.89 9.572L2.968 15.488L8 11.832L13.032 15.488L11.11 9.572L16 5.744H10Z" fill="#DCC2AB" />
                        </svg>
                        <span class="fw-600 ls-2 ps-2 lh-1">5/5 Rating</span>
                    </div>
                    <div class="col-auto d-none d-md-block">
                        <svg width="13" height="13" viewBox="0 0 13 13" fill="none" xmlns="http://www.w3.org/2000/svg">
                            <path d="M12.6828 2.03539L10.9646 0.317191C10.7615 0.114094 10.4859 0 10.1987 0C9.91141 0 9.63591 0.114094 9.43275 0.317191L7.96697 1.78297L11.217 5.03302L12.6828 3.56725C12.8859 3.36409 13 3.08858 13 2.80132C13 2.51405 12.8859 2.23855 12.6828 2.03539Z" fill="#DCC2AB" />
                            <path d="M7.19996 2.54998L1.08335 8.66659L0 13L4.33341 11.9166L10.45 5.80004L7.19996 2.54998Z" fill="#DCC2AB" />
                        </svg>
        ...
        <div class="row gy-4">
            <div class="col-md-8">
                <div class="flight_center">
                    <div>
                        <div class="fs-40 font-articulat-heavy lh-3">More <span class="text-secondary-light">Options.</span></div>
                        <div class="fs-40 font-articulat-heavy lh-3">More <span class="text-paleyellow">Confidence.</span></div>
                    </div>
                </div>
            </div>
            <div class="col-md">
                <div class="h-100 bg-secondary rounded-20 text-center d-flex align-items-center flex-column justify-content-center py-5 py-md-4 px-md-4">
                    <div class="fs-32 ls-2 text-white fw-700 lh-1 pb-3">Compare Beauty <br class="d-none d-md-block">Equipment Loans Online</div>
